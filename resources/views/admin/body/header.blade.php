<nav class="navbar custom-navbar navbar-expand-lg py-2">
    <div class="container-fluid px-0">
        ...
        <a href="index.html" class="navbar-brand"><img src="{{ asset('backend/assets/images/brand/icon.svg') }}" alt="BigBucket" /> <strong>Big</strong> Bucket</a>
        <div id="navbar_main">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <a class="dropdown-item" href="{{ route('admin.logout') }}"><i class="fa fa-sign-out text-primary"></i>Sign out</a>
                    </div>
                </li>
            </ul>
        </div>
