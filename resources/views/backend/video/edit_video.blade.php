    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card">
                ...
                <div class="body">
                    <form class="forms-sample" method="POST" action="{{ route('video.update',$video->id) }}" >@csrf
                        <div class="row clearfix">
                            <div class="col-md-6">
                                <label class="col-form-label">Title<span class="text-danger">*</span></label>
                                <div class="form-group">
                                    <input  type="text" name="title" class="form-control"  value="{{ $video->title }}"  autofocus>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <textarea type="text" name="embed_code" rows="5" class="form-control"  autofocus >{{ $video->embed_code }}</textarea>
                                    <small class="form-control-feedback">
                                    @error('embed_code')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
