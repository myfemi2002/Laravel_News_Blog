    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card">
                ...
                <div class="body">
                    <form class="forms-sample" method="POST" action="{{ route('website.update',$website->id) }}" >@csrf
                        <div class="row clearfix">
                            <div class="col-md-6">
                                <label class="col-form-label">Website Name<span class="text-danger">*</span></label>
                                <div class="form-group">
                                    <input  type="text" name="website_name" value="{{ $website->website_name }}"  class="form-control"  autofocus>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <input  type="text" name="website_link" value="{{ $website->website_link }}"  class="form-control" autofocus>
                                    <small class="form-control-feedback">
                                    @error('website_link')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
