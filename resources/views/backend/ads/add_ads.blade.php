    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card">
                ...
                <div class="body">
                    <form class="forms-sample" method="POST" action="{{ route('ads.store') }}" enctype="multipart/form-data">@csrf
                        <div class="row clearfix">
                            ...
                            <div class="col-md-4">
                                <label class="col-form-label">Image Upload<span class="text-danger">*</span></label>
